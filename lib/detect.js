...
export function detect(dir) {
  ...
  return {
    ...
    agentConfigs,
    lockfiles,
    empty: !npm && !python && !docker && !goRust && !buildManifests.length && !agentConfigs.length,
  };
}
